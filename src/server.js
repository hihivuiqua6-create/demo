...
Chọn duyệt nếu đã nhận tiền.`,{reply_markup:{inline_keyboard:[[{text:'✅ Duyệt + cộng tiền',callback_data:`accpay:ok:${topupId}`},{text:'❌ Từ chối',callback_data:`accpay:no:${topupId}`}],[{text:'👤 Xem UID',callback_data:`accpay:user:${uid}`}]]}}); return; }
      ...
      if(['admin','themacc','addacc','themacclist','danhmuc','xoadanhmuc','listdanhmuc','xoaacc','xoakho','thongbao','bank','addzalopay','addmomo','listadmin','listuser','users','user','timuser','sethotro','congtien','trutien','duyettien','huytien'].includes(cmd) && !isAccAdmin(cur,uid)){ return; }
